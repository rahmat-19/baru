        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-bs-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{Route('waspang.index')}}">Waspang</a>
                        <a class="collapse-item" href="{{Route('asmen.index')}}">Asmen</a>
            ...
            @can('asmen')
            <li class="nav-item">
                <a class="nav-link" href="{{Route('sto.index')}}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>STO</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{Route('pengajuan.persetujuan')}}">
                    <i class="fas fa-fw fa-table"></i>
